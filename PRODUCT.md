...
Product Inspector Apply constructs and validates the complete next document before committing it once. Failure commits nothing and preserves the recoverable draft. Removing or narrowing durable Product intent requires a consolidated downstream-impact review when Offer or Touchpoint selections would be removed or a Touchpoint Desired Outcome subset would be narrowed; additive changes require no such review.
